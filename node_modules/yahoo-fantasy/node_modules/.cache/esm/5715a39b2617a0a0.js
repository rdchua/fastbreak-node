"main";let mapSettings,mapStandings,mapScoreboard,mapTeams,mapDraft,mapTransactions;_261‍.w("../helpers/leagueHelper.mjs",[["mapSettings",["mapSettings"],function(v){mapSettings=v}],["mapStandings",["mapStandings"],function(v){mapStandings=v}],["mapScoreboard",["mapScoreboard"],function(v){mapScoreboard=v}],["mapTeams",["mapTeams"],function(v){mapTeams=v}],["mapDraft",["mapDraft"],function(v){mapDraft=v}],["mapTransactions",["mapTransactions"],function(v){mapTransactions=v}]]);let extractCallback;_261‍.w("../helpers/argsParser.mjs",[["extractCallback",["extractCallback"],function(v){extractCallback=v}]]);
