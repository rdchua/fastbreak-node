"main";_261‍.x([["mapTeam",()=>mapTeam],["mapRoster",()=>mapRoster],["mapStats",()=>mapStats],["mapDraft",()=>mapDraft],["mapMatchups",()=>mapMatchups],["mapTeamPoints",()=>mapTeamPoints],["parseCollection",()=>parseCollection],["parseLeagueCollection",()=>parseLeagueCollection],["parseTeamCollection",()=>parseTeamCollection],["parseGameCollection",()=>parseGameCollection]]);let mapPlayer;_261‍.w("./playerHelper.mjs",[["mapPlayer",["mapPlayer"],function(v){mapPlayer=v}]]);let mergeObjects,flattenObject;_261‍.w("./sharedHelpers.mjs",[["mergeObjects",["mergeObjects"],function(v){mergeObjects=v}],["flattenObject",["flattenObject"],function(v){flattenObject=v}]]);


       function mapTeam(t) {
  const team = _261‍.a("mergeObjects",mergeObjects)(t);
  // clean up team_logos
  ...
  for (let i = 0; i < count; i++) {
    ...
    player = _261‍.a("mapPlayer",mapPlayer)(player);
