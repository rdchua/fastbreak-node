"main";_261‍.x([["mapPlayer",()=>mapPlayer],["mapStats",()=>mapStats],["mapOwnership",()=>mapOwnership],["mapDraftAnalysis",()=>mapDraftAnalysis],["parseCollection",()=>parseCollection],["parseLeagueCollection",()=>parseLeagueCollection],["parseTeamCollection",()=>parseTeamCollection]]);let mergeObjects;_261‍.w("./sharedHelpers.mjs",[["mergeObjects",["mergeObjects"],function(v){mergeObjects=v}]]);let mapTeam;_261‍.w("./teamHelper.mjs",[["mapTeam",["mapTeam"],function(v){mapTeam=v}]]);


       function mapPlayer(p) {
  const player = _261‍.a("mergeObjects",mergeObjects)(p);
  ...
  return _261‍.a("mergeObjects",mergeObjects)(da);
}
  ...
  return teams.map(t => {
    let team = _261‍.a("mapTeam",mapTeam)(t.team[0]);
